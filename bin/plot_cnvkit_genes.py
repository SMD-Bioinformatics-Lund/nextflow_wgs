...
def main(args):
    ...
    plot_gene_cnv(gene,gtf_file,cnr_file,cns_file,flank=50_000,ymin=-5,ymax=5,out_png=out_file,vcf_file=args.scored_vcf)
...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Plots gene coverage for provided gene name for a given CNVkit called sample")
