...
workflow NEXTFLOW_WGS {
	...
	ch_sample_meta_v2  = PREPARE_META_CHANNELS.out.sample_meta
	ch_proband_meta_v2 = PREPARE_META_CHANNELS.out.proband_meta
	ch_case_meta_v2    = PREPARE_META_CHANNELS.out.case_meta
	ch_fastq_meta_v2   = PREPARE_META_CHANNELS.out.fastq
	ch_bam_meta_v2     = PREPARE_META_CHANNELS.out.bam
	ch_vcf_meta_v2     = PREPARE_META_CHANNELS.out.vcf
